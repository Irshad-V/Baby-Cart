...
const DownsideProductCard = ({ category, heading }) => {
    ...
    return (
        <div className='container px-4 my-4 position-relative'>
            ...
            <div className='position-relative'>
                ...
                <div className='d-flex scroll-navigation-bar-head align-items-center gap-2 gap-md-6 overflow-auto scrollbar-none transition ' ref={scrollElement}>
                   ...
                   
                    {
                        loading ? (
                            ...
                            data.map((product) => (
                                <Link to={`product/${product._id}`} key={product._id} className='w-100 downside-product-card bg-white rounded shadow text-center ' style={{ textDecoration: 'none', }}>
                                    <div className='bg-light p-4 image-placeholder-downside  '>
                                        <img
                                            src={product.productImage[0]}
                                            alt={product.productName}
                                            className='img-fluid h-100 image-downside object-scale-down hover-scale '
                                        />
                                    </div>
                                    <div className='px-2 py-1 d-block justify-content-center align-items-center text-center  w-100 '>
                                        <h2 className='fw-medium fs-5  text-dark'>{product.productName}</h2>
...
export default DownsideProductCard
