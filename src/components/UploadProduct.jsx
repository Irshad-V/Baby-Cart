...
const UploadProduct = ({ onClose, fetchData }) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        const dataResponse = await axios.post(`${process.env.REACT_APP_BACK_END}/uploadProduct`, data, {
    ...
    return (
        <div className="position-fixed w-100 h-100 top-0 d-flex align-items-center justify-content-center bg-opacity-75 bg-dark">
            <div className="card card-upload card-margin p-4 shadow" style={{ maxWidth: '400px', width: '90%', maxHeight: '400px' ,overflowY: 'auto'}}>
